  ...
  return (
    <div className="px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-black text-zinc-100">Analyze Your Inventory</h1>
        <p className="mt-1 text-sm text-zinc-500">
          Upload an eBay CSV export or browse the scored demo inventory below.
        </p>
      </div>
      ...
      <div className="mb-8 grid gap-8 xl:grid-cols-3">
        <div className="xl:col-span-1">
          <h2 className="mb-3 text-xs font-bold uppercase tracking-widest text-zinc-600">
            Import Data
          </h2>
          <CSVUploader
            userId="demo"
